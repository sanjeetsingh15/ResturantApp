...
(function (window, emr, undefined) {
    var getIndexedDBStorage = function () {
        ...
        var IndexedDBImpl = function () {
            ...
            request.onsuccess = function() {
                ...
                console.log("Store Success On Local DB duck");
            };
            ...
            this.add = function (key, value) { console.log("2");
            ...
            this.delete = function (key) {  console.log("3");
                var transaction = db.transaction(['tile'], 'readwrite');
                var objectStore = transaction.objectStore('tile');
                objectStore.delete(key);
            };

            this.get = function (key, successCallback, errorCallback) {  console.log("4");
    ...
    var getWebSqlStorage = function () {  console.log("5");
        ...
        var WebSqlImpl = function () {
            ...
            this.add = function (key, value) {  console.log("6");
                db.transaction(function (tx) {
                    tx.executeSql('INSERT INTO tile (key, value) VALUES (?, ?)', [key, value]);
                });
            };

            this.delete = function (key) {   console.log("7");
                db.transaction(function (tx) {
                    tx.executeSql('DELETE FROM tile WHERE key = ?', [key]);
                });
            };

            this.get = function (key, successCallback, errorCallback) {  console.log("8");
                db.transaction(function (tx) {
