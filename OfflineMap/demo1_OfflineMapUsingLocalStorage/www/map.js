...
function CustomControl(controlDiv, map, title, handler) {  console.log("8");
...
prepareWebStorageDiv.index = 1;  console.log("10");
map.controls[google.maps.ControlPosition.TOP_RIGHT].push(clearWebStorageDiv);  console.log("11");
map.controls[google.maps.ControlPosition.TOP_RIGHT].push(prepareWebStorageDiv);  console.log("12");
